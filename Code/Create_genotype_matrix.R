...
# The SNPs between gene_start-5KB, gene_end+5KB locations are used as SNP_set in the manuscript. See manuscript's 4.1 Real Data Preprocessing section for more details.
